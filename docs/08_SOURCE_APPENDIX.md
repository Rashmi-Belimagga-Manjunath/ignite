...
> Full generated source for the IGNITE codebase. 28 files.
...
## `src/components/Footer.jsx` — 71 lines
...
## `src/components/Navbar.jsx` — 92 lines
...
## `src/pages/Agents.jsx` — 156 lines
